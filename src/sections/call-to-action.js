  ...
  return (
    <Box sx={styles.wrapper}>
      <Container sx={styles.container}>
        <Box sx={styles.inner}>
          <Heading as="h3">
            Inscrivez-vous dès maintenant pour être informé du lancement de notre application <br />
            et recevez une offre exclusive de pré-lancement.
          </Heading>
          <Box sx={styles.btnWrapper}>
            <Button sx={styles.btn} >
              <ScrollLink
                ...
                offset={-70}
                duration={500}
                to={"banner"}>INSCRIPTION</ScrollLink>
            </Button>
          </Box>
        </Box>
      </Container>

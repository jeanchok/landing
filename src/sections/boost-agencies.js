...
import image1 from 'assets/mockupphone.png';
          ...
          <Flex sx={styles.col}>
            <Box sx={styles.content}>
              <Box sx={styles.titleBox}>
                <Heading as="h3">
                  Améliorez vos conversions e-commerce avec notre Chatbot
                </Heading>
                <Text as="p">
                  En fournissant une assistance client instantanée et un soutien à la décision d'achat, notre chatbot propulsé par ChatGPT améliore l'expérience utilisateur, ce qui se traduit par un taux de conversion plus élevé et une augmentation des ventes.
                </Text>
              </Box>
